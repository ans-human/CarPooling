...
public class CarPoolingApp {
    ...
    private static void onboarding(UserService userService, RideService rideService) {
        userService.addUser(User.builder().name("Rohan").gender("M").age(36).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
        userService.addVehicle(userService.getUserById("Rohan"), new Vehicle("Rohan", "Swift", "KA-01-12345"));

        userService.addUser(User.builder().name("Shashank").gender("M").age(29).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
        userService.addVehicle(userService.getUserById("Shashank"), new Vehicle("Shashank", "Baleno", "TS-05-62395"));

        userService.addUser(User.builder().name("Nandini").gender("F").age(29).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());

        userService.addUser(User.builder().name("Shipra").gender("F").age(27).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
        ...
        userService.addUser(User.builder().name("Gaurav").gender("M").age(29).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());

        userService.addUser(User.builder().name("Rahul").gender("M").age(35).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
        userService.addVehicle(userService.getUserById("Rahul"), new Vehicle("Rahul", "XUV", "KA-05-1234"));

        userService.addUser(User.builder().name("Sohan").gender("M").age(35).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
        userService.addVehicle(userService.getUserById("Sohan"), new Vehicle("Sohan", "Swift", "KA-01-1235"));

        userService.addUser(User.builder().name("Mohan").gender("M").age(35).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
        userService.addVehicle(userService.getUserById("Mohan"), new Vehicle("Mohan", "Swift", "KA-01-1236"));

        userService.addUser(User.builder().name("Anshuman").gender("M").age(24).ridesOffered(new ArrayList<>()).ridesTaken(new ArrayList<>()).vehicles(new ArrayList<>()).build());
